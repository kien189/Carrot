        ...
        <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="mb-30" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
                        ...
                        <div class="cr-banner-sub-title">
                            <p>Prepared is me Carrot pleasure likewise debating. Wonder an unable except better stairs
                                do ye
            ...
            <div class="row padding-t-100 mb-minus-24">
                <div class="col-md-6 col-12 mb-24" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29810.23971644808!2d105.65795576296715!3d20.941269263891588!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313451fa9260796b%3A0x52aca04f37976c75!2zVGnDqm4gUGjGsMahbmcsIENoxrDGoW5nIE3hu7ksIEjDoCBO4buZaSwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1720711059749!5m2!1svi!2s"
                     width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="maps"></iframe>
                </div>
                <div class="col-md-6 col-12 mb-24" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="800">
                    <form class="cr-content-form" action="" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <input type="text" placeholder="Title" name="title" class="cr-form-control">
                        </div>
                        <div class="form-group">
                            <input type="text" placeholder="Full Name" name="name" class="cr-form-control">
                        </div>
                        <div class="form-group">
                            <input type="email" placeholder="Email" name="email" class="cr-form-control">
                        </div>
                        <div class="form-group">
                            <input type="text" placeholder="Phone" name="phone" class="cr-form-control">
                        </div>
                        <div class="form-group">
                            <textarea class="cr-form-control" id="exampleFormControlTextarea1" name="message" rows="4" placeholder="Message"></textarea>
                        </div>
                        <div class="form-group">
