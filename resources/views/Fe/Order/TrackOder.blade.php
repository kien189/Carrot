                ...
                <div class="container">
                    <div class="cr-track-box">
                        ...
                        <div class="text-center mt-3">
                            <form class="cr-search d-flex justify-content-center align-items-center" action="{{ route('getSearch') }}" method="get">
                                <div class="input-group w-50">
                                    <input class="form-control" name="search" type="text"  placeholder="Look up your order..." required>
                                    <div class="input-group-append">
                                        <button style="background-color: #64b496" class="btn btn-secondary" type="submit">
