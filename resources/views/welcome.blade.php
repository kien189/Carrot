...
<main class="wrapper sb-default">
                            ...
                            <div class="cr-hover-drop-panel right">
                                <ul>
                                    ...
                                    <li><a href="javascript:void(0)"><img class="flag"
                                                                          ...
                                                                          alt="flag">Hindi</a></li>
                                    <li><a href="javascript:void(0)"><img class="flag"
                                                                          src="{{ asset('assets_ad') }}/img/flag/de.png"
                            ...
                            <div class="cr-hover-drop-panel right">
                                ...
                                <ul>
                                    ...
                                    <li><a href="javascript:void(0)"><img class="app"
                                                                          ...
                                                                          alt="flag">Hindi</a></li>
                                    <li><a href="javascript:void(0)"><img class="app"
                                                                          src="{{ asset('assets_ad') }}/img/apps/3.png"
                                                                          alt="flag">Deutsch</a></li>
                                    <li><a href="javascript:void(0)"><img class="app"
    ...
    <div class="cr-sidebar" data-mode="light">
        <div class="cr-sb-logo">
            ...
            <a href="index.html" class="sb-collapse"><img src="{{ asset('assets_ad') }}/img/logo/collapse-logo.png"
                                                          alt="logo"></a>
        </div>
                            ...
                            <li>
                                ...
                                <div class="detail">
                                    ...
                                    <p class="message">Hello, I am sending some file. Please use this in landing page.
                                        And make sure this all files are comppress.</p>
                    ...
                    <div class="cr-card">
                        <div class="cr-card-content label-card">
                            <div class="alert-popup">
                                <ul>
                                    <li>A basic message
                                        <button class="pop-basic cr-btn-primary">Click</button>
                                    </li>
                                    <li>A Success message
                                        <button class="pop-success cr-btn-primary">Click</button>
                                    </li>
                                    <li>A title with a text under
                                        <button class="pop-text-under cr-btn-primary">Click</button>
                                    </li>
                                    <li>A modal with a title, an error icon, a text, and a footer
                                        <button class="pop-error-icon cr-btn-primary">Click</button>
                                    </li>
                                    <li>A modal window with a long content inside:
                                        <button class="pop-long-content cr-btn-primary">Click</button>
                                    </li>
                                    <li>Custom HTML description and buttons with ARIA labels
                                        <button class="pop-like cr-btn-primary">Click</button>
                                    </li>
                                    <li>A dialog with three buttons
                                        <button class="pop-save cr-btn-primary">Click</button>
                                    </li>
                                    <li>A custom positioned dialog
                                        <button class="pop-positioned-timeout cr-btn-primary">Click</button>
                                    </li>
                                    <li>Custom animation with Animate.css
                                        <button class="pop-fade-down cr-btn-primary">Click</button>
                                    </li>
                                    <li>A confirm dialog, with a function attached to the "Confirm"-button
                                        <button class="pop-delete cr-btn-primary">Click</button>
                                    </li>
                                    <li>By passing a parameter, you can execute something else for "Cancel"
                                        <button class="pop-delete-cancel cr-btn-primary">Click</button>
                                    </li>
                                    <li>A message with a custom image
                                        <button class="pop-img cr-btn-primary">Click</button>
                                    </li>
                                    <li>A message with custom width, padding, background
                                        <button class="pop-custom cr-btn-primary">Click</button>
                                    </li>
                                    <li>A message with auto close timer
                                        <button class="pop-auto-close cr-btn-primary">Click</button>
                                    </li>
                                    <li>Right-to-left support for Arabic, Persian, Hebrew, and other RTL languages
                                        <button class="pop-rtl cr-btn-primary">Click</button>
                                    </li>
                                    <li>AJAX request example
                                        <button class="pop-ajax cr-btn-primary">Click</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
