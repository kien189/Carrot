                    ...
                    <div class="cr-card revenue-overview">
                        ...
                        <div class="cr-card-content">
                            <div class="cr-chart-header">
                                ...
                                <div class="block">
                                    <h6>Revenue</h6>
                                    <h5>{{number_format( $totalPrice) }} đ
                                        <span class="up"><i class="ri-arrow-up-line"></i>24%</span>
                                    </h5>
                                </div>
                                <div class="block">
                                    <h6>Expence</h6>
                                    <h5>{{number_format( $totalPrice * 30 / 100  )  }}đ
                                        <span class="down"><i class="ri-arrow-down-line"></i>24%</span>
                                    </h5>
                                </div>
                                <div class="block">
                                    <h6>Profit</h6>
                                    <h5>{{number_format( $totalPrice -($totalPrice * 30 / 100) )  }}
                                        <span class="up"><i class="ri-arrow-up-line"></i>24%</span>
                                    </h5>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/clients/1.jpg"
                                            ...
                                            <tr>
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/clients/2.jpg"
                                            ...
                                            <tr>
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/clients/3.jpg"
                                            ...
                                            <tr>
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/clients/4.jpg"
                                            ...
                                            <tr>
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/clients/5.jpg"
                                            ...
                                            <tr>
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/clients/6.jpg"
                                ...
                                <div class="table-responsive">
                                    <table id="top_product_data_table" class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/product/1.jpg"
                                            ...
                                            <tr>
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/product/2.jpg"
                                            ...
                                            <tr>
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/product/3.jpg"
                                            ...
                                            <tr>
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/product/4.jpg"
                                            ...
                                            <tr>
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/product/5.jpg"
                                            ...
                                            <tr>
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/product/6.jpg"
                                    ...
                                    <table id="recent_order_data_table" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/product/7.jpg"
                                            ...
                                            <tr>
                                                ...
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/product/8.jpg"
                                            ...
                                            <tr>
                                                ...
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/product/9.jpg"
                                            ...
                                            <tr>
                                                ...
                                                <td><img class="cat-thumb"
                                                        src="{{ asset('assets_ad') }}/img/product/10.jpg"
                                                        alt="clients Image"><span class="name">Camera Dron</span>
                                                </td>
                                                <td>Anne Ortha</td>
                                                <td>$854</td>
